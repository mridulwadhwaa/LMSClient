...
const CourseContent: FC<Props> = ({
  ...
  return (
    <div className="w-[80%] m-auto mt-24 p-3">
            ...
            >
              ...
              {!isCollapsed[index] && (
                <>
                  ...
                  <div className="mb-3">
                    <label className={styles.label}>Video Desription</label>
                    <textarea
                      rows={8}
                      cols={30}
      ...
      <div className="w-full flex items-center justify-between">
        <div
          className="w-full 800px:w-[188px] flex items-center justify-center h-[48px] bg-[#37a39a] text-center text-[#fff] rounded mt-8 cursor-pointer"
          onClick={() => prevButton()}
        >
          Prev
        </div>
        <div
          className="w-full 800px:w-[180px] flex items-center justify-center h-[48px] bg-[#37a39a] text-center text-[#fff] rounded at-8 cursor-pointer"
